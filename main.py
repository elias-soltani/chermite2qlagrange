"""
Convert cubic hermite mesh to quadratic Lagrange mesh
"""
...
def create_quad_lagrange_elements(node_ids, points, points2, elem_node_lists):
    ...
    Because I don't know why 1D mesh and 2D mesh don't give me the nodes, I am going to used closest point to generate
     the elements
